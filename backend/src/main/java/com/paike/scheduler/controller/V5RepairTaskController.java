...
public class V5RepairTaskController {
    ...
    @GetMapping("/{taskId}")
    public Result<V5RepairTaskDetailVo> detail(@PathVariable @Positive Long taskId) {
    ...
    public Result<V5RepairTaskDetailVo> cancel(@PathVariable @Positive Long taskId, @Valid @RequestBody(required = false) V5RepairTaskCancelRequest request) {
