...
public class ScheduleGenerateController {
    ...
    @PostMapping
    public Result<ScheduleGenerateResult> generate(@RequestBody ScheduleGenerateRequest request) {
        return Result.success(generateService.generate(request));
    }

    @PostMapping("/multiple")
    public Result<List<ScheduleGenerateResult>> generateMultiple(@RequestBody MultipleScheduleGenerateRequest request) {
